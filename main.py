...
def verify():
    ...
    if name == 'admin' and password == 'admin':
        messagebox.showinfo('Login', 'Seja bem vinda Admin !!')
    elif credentials[0] == name and credentials[1] == password:
        messagebox.showinfo('Login', f'Seja bem vinda {credentials[0]} !!')
...
label_line = Label(frame_up, text='', width=275, anchor=NW, font=('Ivy', 1, 'bold'), bg=cor3,)
label_line.place(
    x=10,
    y=45
)
